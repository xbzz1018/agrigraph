...
import { BarChart, GaugeChart, GraphChart, LineChart, PictorialBarChart, PieChart, RadarChart, ScatterChart } from 'echarts/charts';
import type {
  BarSeriesOption,
  GaugeSeriesOption,
  GraphSeriesOption,
...
export function useEcharts<T extends ECOption>(optionsFactory: () => T, hooks: ChartHooks = {}) {
  ...
  function getDataURL() {
    return chart?.getDataURL({ type: 'png', pixelRatio: 2, backgroundColor: darkMode.value ? '#172019' : '#f7faf8' }) || '';
  }
